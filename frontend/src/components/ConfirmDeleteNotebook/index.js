...
async (e) => {
                                        ...
                                        await dispatch(
                                            getNotebookNotes(notebook.id, "ASC")
                                        );
...
*/
    ...
    const handleSubmit = async (e) => {
        ...
        url.includes("/browser/notebooks") && history.replace("/browser/notebooks");
    };
        ...
        >
            ...
            >
                <div className="confirm-del-text">
                    {`Are you sure you want to delete '${notebook.title}'?`} <br></br>
                    This will delete all the notes in the notebook and cannot be undone.
                </div>
